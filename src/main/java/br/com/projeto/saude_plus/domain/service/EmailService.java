...
public class EmailService {
    ...
    private static final String TEMPLATE_CONSULTA_AGENDADA_PACIENTE = "src/main/resources/templates/email/consulta_agendada/consulta_agendada_paciente.html";
    private static final String ASSUNTO_CONSULTA_AGENDADA_MEDICO = "Nova consulta agendada";
    private static final String TEMPLATE_CONSULTA_AGENDADA_MEDICO = "src/main/resources/templates/email/consulta_agendada/consulta_agendada_medico.html";
    private static final String ASSUNTO_CONSULTA_CANCELADA_PACIENTE = "Consulta cancelada";
    private static final String TEMPLATE_CONSULTA_CANCELADA_PACIENTE_PELO_MEDICO = "src/main/resources/templates/email/consulta_cancelada/pelo_medico/cancelada_paciente.html";
    private static final String TEMPLATE_CONSULTA_CANCELADA_PACIENTE_PELO_PACIENTE = "src/main/resources/templates/email/consulta_cancelada/pelo_paciente/cancelada_paciente.html";
    private static final String ASSUNTO_CONSULTA_CANCELADA_MEDICO = "Consulta cancelada pelo paciente";
    private static final String TEMPLATE_CONSULTA_CANCELADA_MEDICO_PELO_PACIENTE = "src/main/resources/templates/email/consulta_cancelada/pelo_paciente/cancelada_medico.html";
    ...
    public void enviarEmailConsultaCanceladaPaciente(
        ...
        try {
            String conteudoHtml = new String(Files.readAllBytes(Paths.get(TEMPLATE_CONSULTA_CANCELADA_PACIENTE_PELO_PACIENTE)), StandardCharsets.UTF_8)
                    .replace("@nomepaciente", nomePaciente)
                    .replace("@data", data)
                    .replace("@hora", hora)
                    .replace("@nomemedico", nomeMedico)
    ...
    public void enviarEmailConsultaCanceladaMedico(
        ...
        try {
            String conteudoHtml = new String(Files.readAllBytes(Paths.get(TEMPLATE_CONSULTA_CANCELADA_MEDICO_PELO_PACIENTE)), StandardCharsets.UTF_8)
                    .replace("@nomemedico", nomeMedico)
                    .replace("@data", data)
                    .replace("@hora", hora)
                    .replace("@nomepaciente", nomePaciente)
    ...
    public void enviarEmailConsultaCanceladaPorPacienteParaPaciente(
            String emailPaciente,
            String nomePaciente,
            String data,
            String hora,
    ...
    public void enviarEmailConsultaCanceladaPorPacienteParaMedico(
            String emailMedico,
            String nomeMedico,
            String data,
            String hora,
    ...
    public void enviarEmailConsultaCanceladaPorMedicoParaPaciente(
            String emailPaciente,
            String nomePaciente,
            String data,
            String hora,
        ...
        try {
            String conteudoHtml = new String(Files.readAllBytes(Paths.get(TEMPLATE_CONSULTA_CANCELADA_PACIENTE_PELO_MEDICO)), StandardCharsets.UTF_8)
                    .replace("@nomepaciente", nomePaciente)
                    .replace("@data", data)
                    .replace("@hora", hora)
                    .replace("@nomemedico", nomeMedico)
                    .replace("@especialidade", especialidade)
                    .replace("@justificativa", justificativa != null ? justificativa : "");
            File imagem = new File(IMAGEM_ASSINATURA);
            enviarEmailHtmlComImagem(emailPaciente, ASSUNTO_CONSULTA_CANCELADA_PACIENTE, conteudoHtml, imagem);
        } catch (Exception e) {
            throw new RuntimeException("Erro ao enviar e-mail de consulta cancelada pelo médico para paciente: " + e.getMessage(), e);
        }
    }
